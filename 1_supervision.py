#!/usr/bin/env python3
"""Supervise one ComfyUI process and image_generation_server on RunPod.

Starts ComfyUI from /workspace/ComfyUI as:

    python main.py --port 8181 --listen 0.0.0.0
...
def parse_args() -> SupervisorConfig:
    parser = argparse.ArgumentParser(
        description="Monitor and restart one ComfyUI instance plus image_generation_server."
    )
    parser.add_argument(
        "--comfy-dir",
        type=Path,
